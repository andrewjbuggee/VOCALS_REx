%% Plot the mean profile for LWC, re, and Nc versus normalized optical depth

% only use the profiles defined by the logical index provided


function plot_mean_ensemble_LWC_re_NC_vs_norm_optical_depth(ensemble_profiles, index)
...
% can compute the mean, mean and standard deviation
...
plot(re_mean, bin_center, 'Color', mySavedColors(2, 'fixed'))
